...
Get Webapp JSON Data
    [Arguments]     ${figma_text_list}
    ${jscontent}     Get File    ${CURDIR}/getwebdata.js
    ${val}      Execute Javascript      ARGUMENTS       ${figma_text_list}      JAVASCRIPT      ${jscontent}
    #Log    ${val}
